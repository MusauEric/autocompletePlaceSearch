...
class PlacesResultAdapter(
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val tv_address_sub_title = itemView.findViewById<TextView>(R.id.tv_address_sub_title)
        val tv_address_title = itemView.findViewById<TextView>(R.id.tv_address_title)
